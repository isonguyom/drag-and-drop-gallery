...
function Gallery() {
  ...
  const onTouchMove = (e, image) => {
    e.preventDefault();
    console.log(`Touch move over image ID ${image.id}`);
  };
  
  const onTouchEnd = (e, targetImage) => {
    console.log(`Touch dropped at image ID ${targetImage.id}`);
  ...
  useEffect(() => {
    ...
    new Sortable(gridContainer, {
      ...
      onEnd: (e) => {
        ...
        // Handle drag-and-drop reordering as needed
  ...
  return (
    <section className="Gallery">
      ...
      {loading ? (
        ...
        <div className="Gallery-inner" ref={gridContainerRef}>
